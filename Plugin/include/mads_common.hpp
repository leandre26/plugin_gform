#pragma message("✅ [COMMON] Version locale de common.hpp utilisée dans le PLUGIN")
#ifndef COMMON_HPP
#define COMMON_HPP
...
#define INSTALL_SOURCE_DRIVER(klass, type)                                     \
  ...
  public:                                                                      \
    klass##Driver() : SourceDriver(klass::server_name(), klass::kind_static(), klass::version) { \
        #pragma message("🎯 INSTALL_SOURCE_DRIVER: bon constructeur appelé")   \
    }                                                                          \
